export const avoidAMonastery = [
  ...
  {
    10: [
      '9. When he lives in a monastery that is famous and renowned in the world, like Dakkhiṇagiri1 Hatthikucchi, Cetiyagiri or Cittalapabbata, there are always people coming who want to pay homage to him, supposing that he is an Arahant, which inconveniences him. But if it suits him, he can live there at night and go elsewhere by day.',
    ],
    footNotes: {
      1: 'They say it is the Dakkhiṇagiri in the Magadha country” (Vism-mhṭ 116). There is mention of a Dakkhiṇagiri-vihāra at M-a II 293 and elsewhere.',
    },
  },
  {
    11: [
      '10. In one with a nearby city objects of the opposite sex come into focus. Women-pot carriers go by bumping into him with their jars and giving no room to pass. Also important people spread out carpets in the middle of the monastery and sit down.',
    ],
  },
  {
    12: [
  ...
  {
    15: [
      '14. One with a nearby water port of entry or land port of entry3 is made inconvenient by people constantly arriving respectively by ship or by caravan and crowding round, asking for space or for drinking water or salt.',
    ],
    footNotes: {
      3: '“A ‘water port of entry’ is a port of entry on the sea or on an estuary. A ‘land port of entry’ is one on the edge of a forest and acts as the gateway on the road of approach to great cities” (Vism-mhṭ 116).',
    },
  },
  {
    16: [
