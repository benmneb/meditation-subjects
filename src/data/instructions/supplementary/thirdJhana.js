export const thirdJhana = [
  ...
  {
    158: [
      'Equanimity as a divine abiding is a name for equanimity consisting in the mode of neutrality towards beings described thus: “He dwells intent upon one quarter with his heart endued with equanimity” (D I 251).',
    ],
  },
  {
    159: [
      'Equanimity as an enlightenment factor is a name for equanimity consisting in the mode of neutrality in conascent states described thus: “He develops the equanimity enlightenment factor depending on relinquishment” (M I 11).',
    ],
  },
  {
    160: [
      'Equanimity of energy is a name for the equanimity otherwise known as neither over-strenuous nor over-lax energy described thus: “From time to time he brings to mind the sign of equanimity” (A I 257).',
    ],
  },
  {
    161: [
  ...
  {
    162: [
      'Equanimity as a feeling is a name for the equanimity known as neither- pain-nor-pleasure described thus: “On the occasion on which a sense-sphere profitable consciousness has arisen accompanied by equanimity” (Dhs §156).',
    ],
  },
  {
    163: [
      'Equanimity about insight is a name for equanimity consisting in neutrality about investigation described thus: “What exists, what has become, that he abandons, and he obtains equanimity” (M II 264–65, A IV 70f).',
    ],
  },
  {
    164: [
      'Equanimity as specific neutrality is a name for equanimity consisting in the equal efficiency of conascent states; it is contained among the “or-whatever states” beginning with zeal (XIV.133; Dhs-a 132).',
    ],
  },
  {
    165: [
      'Equanimity of jhāna is a name for equanimity producing impartiality towards even the highest bliss described thus: “He dwells in equanimity” (Vibh 245).',
    ],
  },
  {
    166: [
      'Purifying equanimity is a name for equanimity purified of all opposition, and so consisting in uninterestedness in stilling opposition described thus: “The fourth jhāna, which … has mindfulness purified by equanimity” (Vibh 245).',
    ],
  },
  {
    167: [
