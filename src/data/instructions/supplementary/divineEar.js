export const divineEar = [
	...
	},
	{
		...
		footNotes: {
			...
			2: '“The sound sign is the sound itself since it is the cause for the arising of the knowledge. Or the gross-subtle aspect acquired in the way stated is the sound sign” (Vism-mhṭ 402).',
		},
	},
	{
		5: [
		...
		footNotes: {
			3: '“This is momentary-concentration consciousness, which owing to the fact that the preliminary work contingent upon the sound has been performed, occurs in one who has attained the basic jhāna and emerged for the purpose of arousing the divine ear element” (Vism-mhṭ 402).',
		},
	},
	{
		6: [
			'Herein, it is knowledge arisen together with the absorption consciousness that is called the divine ear element. After that [absorption has been reached, the divine ear element] becomes merged in that ear [of knowledge].4 When consolidating it, he should extend it by delimiting a single finger-breadth thus, “I will hear sounds within this area,” then two finger-breadths, four finger- breadths, eight finger-breadths, a span, a ratana (= 24 finger-breadths), the interior of the room, the veranda, the building, the surrounding walk, the park belonging to the community, the alms-resort village, the district, and so on up to the [limit of the] world-sphere, or even more. This is how he should extend it by delimited stages.',
		],
		footNotes: {
			4: '“‘Becomes merged’ is amalgamated with the divine ear element. He is called an obtainer of divine-ear knowledge as soon as the absorption consciousness has arisen. The meaning is that there is now no further need of development for the purpose” (Vism-mhṭ 403).',
		},
	},
	{
		7: [
