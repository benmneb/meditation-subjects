export const fourthJhana = [
	...
	{
		188: [
			'And during the second-jhāna access too, which has multiple advertings, there could be rearising of the [mental] grief faculty, although it had already ceased there, because it arises when there is bodily weariness and mental vexation, which have applied thought and sustained thought as their condition, but it does not arise when applied and sustained thought are absent. When it arises, it does so in the presence of applied and sustained thought, and they are not abandoned in the second-jhāna access; but this is not so in the second jhāna itself because its conditions are abandoned there.',
		],
	},
	{
		189: [
	...
	{
		192: [
			'Or alternatively, just as, although mistaken view of individuality, etc., have already been abandoned in the earlier paths, they are nevertheless mentioned as abandoned in the description of the third path for the purpose of recommending it (cf. §155), so too these kinds of feeling can be understood as mentioned here for the purpose of recommending this jhāna. Or alternatively, they can be understood as mentioned for the purpose of showing that greed and hate are very far away owing to the removal of their conditions; for of these, pleasure (bliss) is a condition for joy, and joy for greed; pain is a condition for grief and grief for hate. So with the removal of pleasure (bliss), etc., greed and hate are very far away since they are removed along with their conditions.',
		],
	},
	{
		193: [
	...
	{
		197: [
			'Then it was said, which abandons one factor, possesses two factors (§183); here the abandoning of the one factor should be understood as the abandoning of joy. But that joy is actually abandoned in the first impulsions of the same cognitive series (cf. §185). Hence it is called its factor of abandoning.',
