export const general = [
	...
	{
		28: [
			'Of these, the earth kasiṇa is the basis for such powers as the state described as “Having been one, he becomes many” (D I 78), etc., and stepping or standing or sitting on space or on water by creating earth, and the acquisition of the bases of mastery (M II 13) by the limited and measureless method.',
		],
	},
	{
		29: [
			'The water kasiṇa is the basis for such powers as diving in and out of the earth (D I 78), causing rain, storms, creating rivers and seas, making the earth and rocks and palaces quake (M I 253).',
		],
	},
	{
		30: [
			'The fire kasiṇa is the basis for such powers as smoking, flaming, causing showers of sparks, countering fire with fire, ability to burn only what one wants to burn (S IV 290), [176] causing light for the purpose of seeing visible objects with the divine eye, burning up the body by means of the fire element at the time of attaining Nibbāna (M-a IV 196).',
		],
	},
	{
		31: [
	...
	{
		32: [
			'The blue kasiṇa is the basis for such powers as creating black forms, causing darkness, acquisition of the bases of mastery by the method of fairness and ugliness, and attainment of the liberation by the beautiful (see M II 12).',
		],
	},
	{
		33: [
			'The yellow kasiṇa is the basis for such powers as creating yellow forms, resolving that something shall be gold (S I 116), acquisition of the bases of mastery in the way stated, and attainment of the liberation by the beautiful.',
		],
	},
	{
		34: [
